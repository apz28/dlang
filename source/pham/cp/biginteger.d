...
Flag!"negative" toNegativeFlag(bool value) nothrow pure
{
    return value ? Yes.negative : No.negative;
}

Flag!"unsigned" toUnsignedFlag(bool value) nothrow pure
{
...
public:
    ...
    /// </summary>
    /// <param name="value"></param>
    private this(scope const(uint)[] value) pure nothrow
    {
        setInts(value);
    }
    ...
    T opCast(T: bool)() const nothrow pure @nogc
    {
        return !isZero();
    }

    T opCast(T)() nothrow pure @nogc
    if (is(Unqual!T == BigInteger))
    {
        return this;
    }
    ...
    int opCmp(int other) const nothrow pure @nogc
    {
        return opCmp(cast(long)other);
    }

    int opCmp(uint other) const nothrow pure @nogc
    {
        return opCmp(cast(ulong)other);
    }

    int opCmp(long other) const nothrow pure @nogc
    {
        debug assertValid();
    ...
    int opCmp(ulong other) const nothrow pure @nogc
    {
        debug assertValid();
    ...
    int opCmp(const BigInteger other) const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool opEquals(int other) const nothrow pure @nogc
    {
        return opEquals(cast(long)other);
    }

    bool opEquals(uint other) const nothrow pure @nogc
    {
        return opEquals(cast(ulong)other);
    }

    bool opEquals(long other) const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool opEquals(ulong other) const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool opEquals(const BigInteger other) const nothrow pure @nogc
    {
        debug assertValid();
        debug other.assertValid();
    ...
    bool isEven() const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool isOne() const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool isPowerOfTwo() const nothrow pure @nogc
    {
        debug assertValid();
    ...
    bool isZero() const nothrow pure @nogc
    {
        debug assertValid();
    ...
    int sign() const nothrow pure @nogc
    {
        debug assertValid();
    ...
    double toFloat() const nothrow pure @nogc
    {
        debug assertValid();
...
private:
    ...
    static ptrdiff_t getDiffLength(const(uint)[] rgu1, const(uint)[] rgu2, ptrdiff_t cu) nothrow pure @nogc
    {
...
int compare(const BigInteger left, const BigInteger right) nothrow pure
{
